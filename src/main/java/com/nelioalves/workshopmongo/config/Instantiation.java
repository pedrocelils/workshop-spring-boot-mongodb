...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("21/02/2005"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite!", sdf.parse("28/02/2005"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Teha um ótimo dia!", sdf.parse("30/02/2005"), new AuthorDTO(alex));
